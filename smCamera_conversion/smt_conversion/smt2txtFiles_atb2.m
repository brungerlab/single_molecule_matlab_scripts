...
path = '/Users/brunger/Dropbox/archive/programs/single_molecule/fusion_detector/examples/';   % path for data folder
...
%     pos_eof_file  = ftell(fid)
    ...
    for i=1:cntPeak
        ...
        saveFileName = [filenamehead '_' num2str(i) '_' num2str(Xpos1) '_' num2str(Ypos1) '_' num2str(Xpos2) '_' num2str(Ypos2) '.txt'];
